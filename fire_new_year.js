...
var fireToRight = false;
var fireToLeft = false;
var withoutFire = true;

function setFireToRight(){
    fireToRight = true;
    fireToLeft = false;
    withoutFire = false;
}

function setFireToLeft(){
    fireToLeft = true;
    withoutFire = false;
    fireToRight = false;
}

function setWithoutFire(){
    withoutFire = true;
    fireToLeft = false;
    fireToRight = false;
}
...
function updateFireIntensityPerPixel(currentPixelIndex){
    ...
    } else if(fireToLeft === true){
        firePixelsArray[currentPixelIndex - decay] = newFireIntensity;
    } else if(withoutFire === true) {
...
function renderAnimation(){
    ...
    html += '</table>';
    html +='<button onclick="setWithoutFire()">Sem vento</button>';
    html +='<button onclick="setFireToRight()">Vento para a direita</button>';
    html +='<button onclick="setFireToLeft()">Vento para a esquerda</button>';
